...
static ZED_BYTE s_ScanToKey[ 128 ] =
{
	...
	ZED_KEY_D, ZED_KEY_F, ZED_KEY_G, ZED_KEY_H, ZED_KEY_J, ZED_KEY_K,	// 0x28
		ZED_KEY_L, ';',
	'\'', '`', ZED_KEY_SHIFT, '\\', ZED_KEY_Z, ZED_KEY_X, ZED_KEY_C,	// 0x30
		ZED_KEY_V,
	ZED_KEY_B, ZED_KEY_N, ZED_KEY_M, ',', '.', '/', ZED_KEY_SHIFT,		// 0x38
		ZED_KEY_NP_ASTERISK,
	ZED_KEY_ALT, ' ', ZED_KEY_CAPSLOCK, ZED_KEY_F1, ZED_KEY_F2,			// 0x40
		ZED_KEY_F3, ZED_KEY_F4, ZED_KEY_F5,
